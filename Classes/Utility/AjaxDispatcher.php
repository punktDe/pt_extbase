...
class Tx_PtExtbase_Utility_AjaxDispatcher
{
    ...
    {
        if (!$this->extensionName || !$this->controllerName || !$this->actionName) {
            throw new \Exception('Either extension, controller or action is undefined.', 1391146166);
        }
    ...
    public function initCallArguments()
    {
        ...
        $this->pluginName = $this->pluginName ?: $this->requestArguments['pluginName'];
        $this->controllerName = $this->controllerName ?: $this->requestArguments['controllerName'];
