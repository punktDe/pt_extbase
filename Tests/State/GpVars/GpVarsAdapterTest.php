 ...
 */
class Tx_PtExtbase_Tests_State_GpVarsAdapterTest extends Tx_PtExtbase_Tests_AbstractBaseTestcase {
	...
	public function requiredClassesExist() {
		...
		$this->assertTrue(class_exists('Tx_PtExtbase_Tests_State_Stubs_PersistableObject'));
	}
    ...
    public function parametersCanBeInjectedIntoObject() {
    	...
    	$object = new Tx_PtExtbase_Tests_State_Stubs_GetPostVarObject();
