 ...
 */
class Tx_PtExtbase_Tests_State_Session_SessionPersistenceManagerTest extends Tx_PtExtbase_Tests_AbstractBaseTestcase {
	...
	public function getSessionDataByNamespaceReturnsCorrectValue() {
		$sessionAdapterMock = new Tx_PtExtbase_Tests_State_Stubs_SessionAdapterMock();
