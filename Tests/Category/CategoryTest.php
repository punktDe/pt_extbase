 ...
 */
class Tx_PtExtbase_Tests_Category_CategoryTest extends Tx_PtExtbase_Tests_AbstractBaseTestcase {
     
	/** @test */
	public function constructReturnsInitializedCategory() {
		$category = new Tx_PtExtbase_Category_Category();
	...
	public function getChildCountReturnsOneForOneAddedChild() {
		$parentCategory = new Tx_PtExtbase_Category_Category();
        $childCategory1 = new Tx_PtExtbase_Category_Category();
	...
	public function getChildCountReturnsOneForAddedChildOfChild() {
	    $parentCategory = new Tx_PtExtbase_Category_Category();
        $childCategory1 = new Tx_PtExtbase_Category_Category();
        $childCategory2 = new Tx_PtExtbase_Category_Category();
    ...
    public function getSubCategoriesReturnsSubCategoriesInCorrectOrder() {
    	$parentCategory = new Tx_PtExtbase_Category_Category('1');
        $childCategory1 = new Tx_PtExtbase_Category_Category('1.1');
        $childCategory2 = new Tx_PtExtbase_Category_Category('1.1.1');
        $childCategory3 = new Tx_PtExtbase_Category_Category('1.2');
        $childCategory4 = new Tx_PtExtbase_Category_Category('1.2.1');
        $childCategory5 = new Tx_PtExtbase_Category_Category('1.2.2');
    ...
    public function addChildBeforeAddsChildBeforeGivenChild() {
    	$child1 = new Tx_PtExtbase_Category_Category('1.1'); 
    	$child2 = new Tx_PtExtbase_Category_Category('1.2');
    	$child3 = new Tx_PtExtbase_Category_Category('1.3');
    	$parent = new Tx_PtExtbase_Category_Category('1');
