 ...
 */
class Tx_PtExtbase_Tests_Lifecycle_ManagerTest extends Tx_PtExtbase_Tests_AbstractBaseTestcase {
	...
	public function observerCanBeRegistered() {
		$lifecycleManager = new Tx_PtExtbase_Lifecycle_Manager();
		$observeableObject = new Tx_PtExtbase_Tests_Lifecycle_ManagerTest_ObservableMock();
	...
	public function nonStaticObserverCanBeRegisteredMultipleTimes() {
		$lifecycleManager = new Tx_PtExtbase_Lifecycle_Manager();
		$observeableObject1 = new Tx_PtExtbase_Tests_Lifecycle_ManagerTest_ObservableMock();
		$observeableObject1->state = 2;
		$observeableObject2 = new Tx_PtExtbase_Tests_Lifecycle_ManagerTest_ObservableMock();
...
class Tx_PtExtbase_Tests_Lifecycle_ManagerTest_ObservableMock implements Tx_PtExtbase_Lifecycle_EventInterface {
