 ...
 */
class Tx_PtExtbase_Tests_Unit_Parser_SqlMultipleQueriesFileParserTest extends \PunktDe\PtExtbase\Testing\Unit\AbstractBaseTestcase
{
    ...
    {
        $this->proxyClass = $this->buildAccessibleProxy(\Tx_PtExtbase_Parser_Sql_MultipleQueriesFileParser::class);
