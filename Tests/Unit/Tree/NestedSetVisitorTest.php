 ...
 */
class Tx_PtExtbase_Tests_Unit_Tree_NestedSetVisitorTest extends \PunktDe\PtExtbase\Testing\Unit\AbstractBaseTestcase
{
    /** @test */
    ...
    public function visitorCorrectlyCreatesLeftRightEnumerationOnTree()
    {
        ...
        $visitor = new Tx_PtExtbase_Tree_NestedSetVisitor();
        $treeWalker = new Tx_PtExtbase_Tree_TreeWalker([$visitor]);
